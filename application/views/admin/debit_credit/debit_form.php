...
<?php
$query="SELECT * FROM supplier WHERE user_id = ?";
$custpayq = $this->db->query($query,array($suppid));
$rowCust = $custpayq->row_array();
$custname = $rowCust['username'];
?>
   ...
   <div style="width:595px; height:auto; margin:0 auto;">
                                 ...
                                 <div style="width:100%; float:left;margin-bottom:40px;">
                                   <div style="width:100%; float:left">	
                                    <h5 style="width:26%; float:left; font-size:11px; padding:0; margin:0">Supplier Copy</h5>
                                   ...
                                   <div style="width:50%; float:left; font-size:12px;padding:5px 0;">
                                   	Voucher No :  <strong style="text-transform:capitalize; margin-left:10px;"><?php echo $serial_no;?></strong>
                                   </div>
                                  	  	<div style="text-align:right; padding:5px 0; width:50%; float:right; font-weight:bold; font-size:12px">
                                        Supplier: <?php echo $custname;?></div>
                              ...
                              <div style="width:100%; float:left;">
                                   <div style="width:100%; float:left">	
                                    ...
                                    <div style="text-align:left; padding:5px 0">
                                           ...
                                           <address style="width:85%; float:left; text-align:center">
                                            <h3><?php echo $cname;?></h3>                                            
                                            <p><?php echo $cadd;?></p>
