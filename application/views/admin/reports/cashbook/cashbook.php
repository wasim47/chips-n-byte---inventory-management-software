...
function reportsAjax()
{
	...
	var data = '?fdate='+fromdate+'&tdate='+todate+"&action="+submitbtn;
	var url = '<?php echo base_url('admin/cashbook_print')?>';
                                     ...
                                     <table width="100%" border="0" cellspacing="5" cellpadding="0" align="left">
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <input type="button" name="submit" id="submitbtn" value="View Reports" class="btn btn-success" 
                                                        onclick="reportsAjax();" style="margin-top:3px;" /></td>
                                                    </tr>
                                              </table>
                                  </div>
                                </div>
