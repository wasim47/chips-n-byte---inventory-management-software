  ...
  <div style="width:100%; height:auto;" class="printfontsize">
       <table width="100%" class="summTable" border="1">
                                                <tr class="theadline">
                                                  ...
                                                  <td width="80" align="center">S.Code </td>
                                                  <td width="295" align="center">Supplier Name </td>
                                                  <td width="150" align="center">Date </td>
                                                  <td width="104" align="center">Quantity </td>
                                                  <td width="95" align="center">Total Price</td>
                                                </tr>
                                                <?php
                                                    $i=0;
                                                    $tqty = 0;
                                                  ...
                                                  foreach($purproductinfo->result() as $rows){	
													  ...
													  $date=$rows->bid_todaydate;
												  	  ...
												  	  $buyerInfo = $this->Index_model->getAllItemTable('supplier','user_id',$supplier_id,'','','user_id','desc');
													  if($buyerInfo->num_rows() > 0){
                                            ...
                                            <tr class="trCont">
                                              ...
                                              <td width="80" align="center"><?php echo $user_id;?></td>
