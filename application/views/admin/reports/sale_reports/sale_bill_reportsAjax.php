        ...
        <div style="text-align:center; padding:5px 0; width:20%; float:left">&nbsp;</div>
         <div style="text-align:center; padding:5px 0; width:60%; float:left">
                            ...
                            <div style="font-size:13px; text-align:center; margin-bottom:10px;">
                                ...
                                <p><?php echo $cadd;?></p>
                                <h2 style="font-size:22px;margin:0; padding:0; text-decoration:underline">Salse Report (By Bill)</h2>
                                <?php  if($fromdate!=""){?>
  ...
  <div style="width:100%; height:auto;" class="printfontsize">
       <table width="100%" class="summTable" border="1">
                                                <tr class="theadline">
                                                  ...
                                                  <td width="80" align="center">B.Code </td>
                                                  <td width="295" align="center">Buyer Name </td>
                                                  <td width="95" align="center">Bill No </td>
                                                  <td width="150" align="center">Date </td>
                                                  <td width="104" align="center">Quantity </td>
                                                  <td width="95" align="center">Price in Bill </td>
                                                  <td width="95" align="center">Payment </td>
                                                  <td width="143" align="center">Due in Bill</td>
         										</tr>
                                                <?php
                                                    $i=0;
                                                    $tqty = 0;
                                                  ...
                                                  foreach($saleproductinfo->result() as $rows){	
													  ...
													  $saleDetails = $this->Index_model->getAllItemTable('sale_details','bill_no',$bill_no,'','','id','desc');
													  foreach($saleDetails->result() as $rowsald);
													  $total_amount=$rowsald->total_amount;
													  $payment=$rowsald->payment;
													  $dueamount = $total_amount - $payment;
													  
												  	  $buyerInfo = $this->Index_model->getAllItemTable('customers','customer_id',$cust_id,'','','name','desc');
													  foreach($buyerInfo->result() as $rowq);
													  $name=$rowq->name;
													  $cid=$rowq->cid;
                                            ...
                                            <tr class="trCont">
                                              ...
                                              <td width="80" align="center"><?php echo $cid;?></td>
                                              <td width="295" align="left"><?php echo $name;?></td>
                                              <td width="150" align="center"><?php echo $bill_no;?></td>
                                              <td width="150" align="center"><?php echo $date;?></td>
                                              <td align="right"><?php echo $total_qty;?></td>
                                              <td width="95" align="right"><?php echo $total_amount;?></td>
                                              <td width="84" align="right"><?php echo $payment;?></td>
                                              <td width="143" align="right"><?php echo $dueamount;?></td>
         </tr>
                                            <?php
                                            /*$tqty = $tqty + $totalqty;
