...
function reportsAjax()
{
	...
	/*if(reporttype=="By Bill"){
		var url = '<?php echo base_url('admin/sale_products_reports_ajax')?>';
	}
	else if(reporttype=="By Product"){
		var url = '<?php echo base_url('admin/sale_products_reports_ajax')?>';
	}*/
	var data = '?fdate='+fromdate+'&tdate='+todate+'&customer_id='+customer_id+'&sum_type='+sum_type+'&pro_id='+pro_id+"&reporttype="+reporttype;
	var url = '<?php echo base_url('admin/sale_products_reports_ajax')?>';
                                     ...
                                     <table width="100%" border="0" cellspacing="5" cellpadding="0" align="left">
                                                     ...
                                                     <td colspan="2">
                                                      <select name="reporttype" id="reporttype" class="form-control" onchange="reportType();">
                                                            ...
                                                            <option value="By Bill">By Bill</option>
                                                     </select></td>
                                            	</tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td width="38%" height="46" align="right">By Buyer</td>
