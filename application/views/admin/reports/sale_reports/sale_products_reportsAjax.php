        ...
        <div style="text-align:center; padding:5px 0; width:20%; float:left">&nbsp;</div>
         <div style="text-align:center; padding:5px 0; width:60%; float:left">
                            ...
                            <div style="font-size:13px; text-align:center;">
                                ...
                                <p><?php echo $cadd;?></p>
                                <h2 style="font-size:22px;margin:0; padding:0; text-decoration:underline">Salse Report (By Product)</h2>
                                <?php  if($fromdate!=""){?>
  ...
  <div style="width:100%; height:auto;" class="printfontsize">
       <table width="100%" class="summTable" border="1">
                                                <tr class="theadline">
                                                  ...
                                                  <td width="95" align="center">Sale Price </td>
                                                  <td width="96" align="center">Commission </td>
                                                  <td width="84" align="center">Vat </td>
                                            ...
                                            <tr class="trCont">
                                              ...
                                              <td width="95" align="right"><?php echo $price;?></td>
                                              <td width="96" align="right"><?php echo $commission;?></td>
                                              <td width="84" align="right"><?php echo $vat;?></td>
