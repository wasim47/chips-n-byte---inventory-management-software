 ...
 <div class="cs-headertop clearfix cs-sticky-fixed animated fadeInDown">
  <div class="container">
      <div class="col-sm-3 col-xs-12 header-left">
          ...
          <h1 style="font-size:30px; padding-top:10px;"><img src="<?php echo base_url('assets/images/krclogo.png');?>" /></h1></a> </div>
      </div>
                             ...
                             <li style="border-top:1px solid #ccc; padding:10px 0">
                                <table width="100%" class="table" style="margin:0; padding:0;">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url('checkout');?>" class="btn" 
                                                style="font-size:16px; text-align:right; background:#2d2d2d; border-radius:5px;">Checkout</a></td>
                                            </tr>
                                        </table>
                             </li>
                          </ul>
