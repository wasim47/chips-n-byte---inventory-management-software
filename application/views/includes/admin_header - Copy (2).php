            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu" style="margin-top:60px;">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li><a><i class="fa fa-picture-o"></i>Order<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu" style="display: none">
                                            ...
                                            <li><a href="<?php echo base_url('admin/final_order?s='.base64_encode('success'));?>">Successfull Order</a></li>
                                            <li><a href="<?php echo base_url('admin/final_order?s='.base64_encode('return'));?>">Returned Order</a></li>
                                            <li><a href="<?php echo base_url('admin/final_order?s='.base64_encode('miss'));?>">Miss Delivered Order</a></li>
                                            <li><a href="<?php echo base_url('admin/final_order?s='.base64_encode('demage'));?>">Demaged Order</a></li>
                                            <li><a href="<?php echo base_url('admin/final_order?s='.base64_encode('cancel'));?>">Cancelled Order</a></li>
                                        </ul>
                                    </li>
                         ...
                         <?php 
						 if(($this->session->userdata('AdminType')!="Precident") && ($this->session->userdata('AdminType')!="CEO") && ($this->session->userdata('AdminType')!="Country Manager")){
						 // || $this->session->userdata('AdminType')!="CEO" || $this->session->userdata('AdminType')!="Country Manager"
							   ...
							   ?> 
                              	  ...
                              	  <div class="menu_section">
                                  	<h3 style="font-size:16px; margin-left:5px; padding:0;"><?php echo $this->session->userdata('AdminType');?></h3>
                                    <ul class="nav side-menu">
